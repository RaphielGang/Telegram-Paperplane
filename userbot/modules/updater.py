...
from userbot import CMD_HELP, bot, HEROKU_APIKEY, HEROKU_APPNAME
...
async def upstream(ups):
    ...
    off_repo = 'https://github.com/DragonightFury/paperplaneextdftest.git'
    force_update = False
    ...
    if HEROKU_APIKEY is not None:
        ...
        os.popen(f'cd /app && git add -f userbot.session config.env Dockerfile userbot/modules/updater.py userbot/__init__.py && git commit -m "Update userbot"')
