...
PM_PERMIT_IMAGE = os.environ.get("PM_PERMIT_IMAGE") or None
...
BRAIN_ID = os.environ.get("BRAIN_ID") or None
BRAIN_API_KEY = os.environ.get("BRAIN_API_KEY") or None
